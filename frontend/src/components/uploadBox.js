...
const FileInfo = ({ uploadedInfo }) => (
  <ul className={styles.preview_info}>
    ...
    <Button style={{height:"50px",width:"-webkit-fill-available", background:"#e6f3fa"}} onClick={event=>{event.stopPropagation();event.cancelBubble=true;return true;}}text="Send"/>
  </ul>
);
